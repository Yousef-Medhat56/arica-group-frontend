...
const IrrigationNetworksPage: NextPage = (props) => {
    //@ts-ignore
    const {
        content,
        services,
    ...
    return (
        <div>
            <Head>
                <title>{content.irrigationNetworks.title}</title>
                <meta
                    name="description"
                    content={`${
                        content.irrigationNetworks.description
                ...
                <meta
                    property="og:title"
                    content={content.irrigationNetworks.title}
                />
                <meta
...
export default IrrigationNetworksPage;
